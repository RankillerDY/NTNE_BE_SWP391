            ...
            <div class="contain" id="contain">
                <div class="form-contain log-in-contain">
                    <form action="login_handler.do" method="post" id="login">
                        ...
                        <div class="g-recaptcha" data-sitekey="6Lcxsw0nAAAAAC7VdAS1SCQLaIO3Zudcno9x9HOZ"></div>
                        ...
                        <div class="add-on">
                            <div class="btn-google" readonly="readonly">
                                <a href="https://accounts.google.com/o/oauth2/auth?client_id=224681386135-ieoer1kr21a56bnm2mh1pav2ionb4qr3.apps.googleusercontent.com&redirect_uri=https://5337-115-73-31-92.ngrok-free.app/account/login_google.do&response_type=code&scope=email%20profile&access_type=offline">
